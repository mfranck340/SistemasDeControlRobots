...
while(1)
    ...
    robotPose = [position, orientation(1)];% Generamos posicion del robot con respecto a pos 0,0, orientacion(1) --> posicion sobre eje z
    
    % Extraer los rangos y los ángulos del mensaje del láser. ( como leer
    % mensajes del laser--> distancia a onjetos)
